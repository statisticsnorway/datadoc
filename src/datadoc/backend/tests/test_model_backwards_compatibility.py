...
# TODO(@tilen1976): temp remove path resolver before package  # noqa: TD003
def test_handle_version_2_2_0() -> None:
    # pydir: Path = Path(__file__).resolve().parent  # noqa: ERA001
    # rootdir: Path = pydir.parent.parent  # noqa: ERA001
